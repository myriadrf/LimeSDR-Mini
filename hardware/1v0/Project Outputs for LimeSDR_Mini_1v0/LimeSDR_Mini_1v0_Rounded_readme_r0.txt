...
board designation           : LimeSDR_Mini_1v0
board version		        : v1.0
board type                  : Lead Free
board size                  : 69 mm x 31.37 mm
panel size					: 69 mm x 170.68 mm
...
Drill files
-----------------
	- LimeSDR_Mini_1v0_panel.DRR -> Drill report detailing the tool assignments, hole sizes, hole count and tool travel. 
   
	- Throughole vias are covered in the following files:
   								File Name																	Start Layer						Stop Layer
						LimeSDR_Mini_1v0_panel-RoundHoles.TXT													Top								Bottom
	- Slotholes are covered in the following files:
						LimeSDR_Mini_1v0_panel-SlotHoles.TXT														Top								Bottom	
...
---------------
		...
		LimeSDR_Mini_1v0_panel.GTL				Top (RF/Signal/GND)
		LimeSDR_Mini_1v0_panel.G1				L2  (GND)
		LimeSDR_Mini_1v0_panel.G2				L3  (PWR/GND)
		LimeSDR_Mini_1v0_panel.G3				L4  (Signal/PWR/GND)
		LimeSDR_Mini_1v0_panel.G4				L5  (Signal/PWR/GND)
		LimeSDR_Mini_1v0_panel.G5				L6  (CLK/Signal/GND)
		LimeSDR_Mini_1v0_panel.G6				L7  (GND)	
		LimeSDR_Mini_1v0_panel.GBL				Bottom (Signal/PWR/GND)

		 
		LimeSDR_Mini_1v0_panel.GPB				Bottom Pad Master
		LimeSDR_Mini_1v0_panel.GPT				Top Pad Master

		LimeSDR_Mini_1v0_panel.GTO				Top Overlay
		LimeSDR_Mini_1v0_panel.GTP				Top Paste
		LimeSDR_Mini_1v0_panel.GTS				Top Solder

 
		LimeSDR_Mini_1v0_panel.GBS				Bottom Solder
		LimeSDR_Mini_1v0_panel.GBP				Bottom Paste
		LimeSDR_Mini_1v0_panel.GBO				Bottom Overlay


		LimeSDR_Mini_1v0_panel.GM1				Mechanical 1 (Board Cutout)


		LimeSDR_Mini_1v0_panel.GM14				ASM BOT (Assembly bottom)
		LimeSDR_Mini_1v0_panel.GM15				ASM TOP (Assembly top)
