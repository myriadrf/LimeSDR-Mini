...
LimeSDR Mini board peripheral interfaces are presented in Figure 8. The latter block diagrams depict the main ICs, corresponding IC pin numbers, data buses and serial protocol addresses.

.. figure:: /images/LimeSDR-Mini_v1.1_LSI.png
  :width: 600

  Figure 8. LimeSDR Mini v1.1 peripheral interfaces block diagram
...
.. list-table:: Table 9. FPGA EGPIO connector (J5) pins
   :header-rows: 1
